...
// /* =====================================================
//    1️⃣ FETCH ACTIVE SERVICES (PUBLIC)
// ===================================================== */
...
// /* =====================================================
//    2️⃣ CHECK SERVICE AVAILABILITY (PUBLIC)
// ===================================================== */
...
//         `/public/services/${serviceId}/availability?date=${date}`
//       );
//       return res.data.data;
//     } catch (err) {
//       return rejectWithValue(
...
// /* =====================================================
//    3️⃣ CREATE PUBLIC APPOINTMENT (ONE STEP)
// ===================================================== */
...
// /* =====================================================
//    4️⃣ GET APPOINTMENT STATUS (BY ID – PUBLIC)
// ===================================================== */
...
//     try {
//       const res = await api.get(
//         `/public/appointments/${appointmentId}/status`
//       );
//       return res.data.data;
//     } catch (err) {
//       return rejectWithValue(
//         err.response?.data?.message || "Failed to fetch appointment status"
//       );
//     }
//   }
// );
...
//       return res.data?.data || null;
//     } catch (err) {
//       // show server error body if exists
