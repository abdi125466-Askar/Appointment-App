        ...
        <div className="mx-auto max-w-7xl px-6 h-20 flex items-center justify-between">
          <Link to="/" className="flex items-center">
            <img
              src="/logo.png"
              alt="Appointify"
              className="h-10 md:h-45 w-auto object-contain"
            />
          </Link>
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              to="/login"
              className="px-5 py-2 rounded-xl font-bold text-white bg-gradient-to-r from-blue-600 to-emerald-600 shadow-lg shadow-emerald-600/15 hover:brightness-110 transition"
            >
              Admin Login
            </Link>
          </div>
