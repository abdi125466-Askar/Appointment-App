...
//   const [localResult, setLocalResult] = useState(null); // for success display
...
//       const exists = selectedServiceId && services.some((s) => s._id === selectedServiceId);
...
//       !creating
//     );
//   }, [fullName, phone, selectedServiceId, appointmentDate, availability, creating]);
...
//     // ✅ IMPORTANT FIX:
//     // backend multer mararka qaar wuxuu filaa fieldName = "file" ama "document"
//     // si aad uga badbaado mismatch -> ku dir labadaba
//     if (file) {
...
//       const data = resAction.payload;
//       setLocalResult({
//         type: "success",
//         message: "Appointment created ✅",
//         appointmentId: data?.appointmentId || data?._id,
//         status: data?.status,
//         serviceName: data?.service?.name,
//         date: data?.appointmentDate,
//       });
...
//                     {localResult.appointmentId && (
//                       <div className="text-sm mt-1">
//                         Tracking ID:{" "}
//                         <span className="font-black">{localResult.appointmentId}</span>
//                       </div>
//                     )}
//                   </div>
//                 </div>
...
//   // ✅ Support both
//   const serviceIdFromUrl = params.get("serviceId") || "";
//   const serviceSlugFromUrl = params.get("service") || ""; // e.g. passport, national_id_registration, birth_certificate
...
//     // 1) If serviceId exists and matches -> use it
//     const byId =
//       serviceIdFromUrl &&
...
//     // 2) If slug exists -> try match by service.name slug
//     const bySlug =
//       serviceSlugFromUrl &&
//       services.find((s) => slugify(s.name) === slugify(serviceSlugFromUrl));

//     if (bySlug) {
//       setSelectedServiceId(bySlug._id);
//       return;
//     }
...
//       // ✅ payload might be: { success, data: {...} } OR direct data
...
//                 {/* ✅ show info if URL asked serviceId but not found */}
//                 {!!serviceIdFromUrl &&
//                   !servicesLoading &&
//                   services.length > 0 &&
...
//                 {/* ✅ show info if URL asked service slug but not found */}
//                 {!!serviceSlugFromUrl &&
//                   !servicesLoading &&
//                   services.length > 0 &&
//                   !services.some((s) => slugify(s.name) === slugify(serviceSlugFromUrl)) && (
//                     <p className="mt-2 text-xs font-semibold text-amber-700">
...
//                     {typeof availability.remaining === "number" && (
//                       <div className="text-sm mt-1">
//                         Remaining: <span className="font-black">{availability.remaining}</span>
//                       </div>
//                     )}
//                   </div>
//                 </div>
